...
Version  : 3.4.8
Release  : 42
URL      : https://github.com/libffi/libffi/archive/v3.4.8/libffi-3.4.8.tar.gz
Source0  : https://github.com/libffi/libffi/archive/v3.4.8/libffi-3.4.8.tar.gz
...
%prep
%setup -q -n libffi-3.4.8
cd %{_builddir}/libffi-3.4.8
pushd ..
cp -a libffi-3.4.8 build32
popd
pushd ..
cp -a libffi-3.4.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744291549
